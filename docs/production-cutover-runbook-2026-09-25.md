...
3. **Point the Hub at production.** In `apps-script/Code.gs`, change:
...
1. Revert `LEGACY_INVENTORY_SPREADSHEET_ID` and `BADGER_TRACKER_SPREADSHEET_ID` to the staging IDs and redeploy the Inventory API.
